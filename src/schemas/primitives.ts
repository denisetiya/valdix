...
export class LiteralSchema<T extends string | number | boolean | null | undefined>
  extends Schema<T> {
...
export class NeverSchema extends Schema<never> {
  _parse(_input: unknown, ctx: ParseContext): InternalResult<never> {
    ctx.addIssue({ code: "invalid_type" });
    return invalid;
  }
}

export class AnySchema extends Schema<any> {
  _parse(input: unknown, _ctx: ParseContext): InternalResult<any> {
    return ok(input);
  }
}

export class UnknownSchema extends Schema<unknown> {
  _parse(input: unknown, _ctx: ParseContext): InternalResult<unknown> {
    return ok(input);
  }
}
...
export class NullSchema extends Schema<null> {
  _parse(input: unknown, ctx: ParseContext): InternalResult<null> {
    if (input !== null) {
      ctx.addIssue({ code: "invalid_type", expected: "null", received: typeOf(input) });
      return invalid;
    }
    return ok(null);
  }
...
export class UndefinedSchema extends Schema<undefined> {
  _parse(input: unknown, ctx: ParseContext): InternalResult<undefined> {
    if (input !== undefined) {
      ctx.addIssue({ code: "invalid_type", expected: "undefined", received: typeOf(input) });
      return invalid;
    }
    return ok(undefined);
  }
